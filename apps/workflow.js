...
async function refreshWorkflowDashboard(force){
  ...
  try{
    ...
    el.innerHTML='<div class="dt-row"><div class="dt-row-title"><span class="dt-icon dt-blue" aria-hidden="true">📋</span><div><h3>PCSP 전체 갱신</h3><span class="dt-sub">미작성 문서부터 확인하세요</span></div></div>'
      +'<div class="dt-metrics"><div><span>미작성</span><strong>'+missing+'<small>명</small></strong></div><div><span>진행 중</span><strong class="dt-blue-text">'+pending.length+'<small>건</small></strong></div><div><span>갱신 도래</span><strong class="'+(renew?'dt-amber-text':'dt-muted-number')+'">'+renew+'<small>명</small></strong></div></div><a class="dt-button dt-primary" href="operations.html?workflow=pcsp">진행표 보기 →</a></div>'
      +'<div class="dt-row"><div class="dt-row-title"><span class="dt-icon dt-purple" aria-hidden="true">📝</span><div><h3>SDC AUTH</h3><span class="dt-sub">승인 상태와 기간 확인</span></div></div><div class="dt-metrics"><div><span>확인 필요</span><strong>'+noAuth+'<small>명</small></strong></div><div><span>30일 내 만료</span><strong class="dt-amber-text">'+soon+'<small>명</small></strong></div></div><button type="button" class="dt-button dt-outline" onclick="goTab(\'authorization\',null)">AUTH 확인 →</button></div>'
      +'<div class="dt-row"><div class="dt-row-title"><span class="dt-icon dt-mint" aria-hidden="true">🚌</span><div><h3>오늘 출석 · 서비스</h3><span class="dt-sub">AUTH / 교통 확인</span></div></div><div class="dt-clear"><span>확인 필요</span><strong class="'+(checks?'dt-amber-text':'dt-green-text')+'">'+checks+'<small>건</small></strong></div><button type="button" class="dt-button dt-outline" onclick="dashGoAttendance()">출석 서비스 확인 →</button></div>'
      +'<footer class="dt-footer"><span>서버 조회 '+wfEsc(new Date().toLocaleTimeString())+'</span><span>확인 필요는 서비스 미제공 판정이 아닙니다.</span></footer>';
